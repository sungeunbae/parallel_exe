...
This may be good enough for large number of small jobs. However, if the total duration of your jobs exceeds the maximum wall time allowed by your HPC, you will need to consider a solution that supports "checkpoint/resuming". That's why parallel_exe.py was created.
```
#!/bin/bash
...
#SBATCH --nodes=1
