...
# Old way : Why this solution matters?
...
This may be good enough for large number of small jobs. However, if the total duration of your jobs exceeds the maximum wall time allowed by your HPC, what do you do? If you have completed 9000 out of 10000 jobs after 24 hours. You can modify your job file, remove all the jobs that have been completed, then resubmit. This is a manual way of "checkpointing/resuming".

I wanted this done automatically. That's why parallel_exe.py was created.
